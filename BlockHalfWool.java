...
public class BlockHalfWool extends Block
{
    /** Boolean used to seperate different states of blocks */
    private boolean blockType;

    public BlockHalfWool(int par1, boolean par2)
    {
    ...
    {
        return mod_D32d.halfwool.blockID;
    }
    ...
    {
        return new ItemStack(mod_D32d.halfwool.blockID, 1, par1 & 7);
    }
}
